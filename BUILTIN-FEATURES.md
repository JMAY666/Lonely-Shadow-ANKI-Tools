...
托盘工具 Minimize to Tray 2 0.2 与卡片手写 AnkiPenDown 1.1 同样接入主程序；入口、简体中文设置、旧配置兼容和回退见 [托盘与手写说明](docs/DESKTOP-TOOLS.md)。当前更新目标为 `dist/Anki-weak-review-text-26.8.1/Anki.exe`。
